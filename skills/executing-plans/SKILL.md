...
**注意：** 告诉你的 人类搭档，Superpowers 在有子智能体支持时效果要好得多。如果运行在支持子智能体的平台（如 Claude Code 或 Codex）上，其工作质量将显著提高。如果有子智能体可用，请使用 superpowers:subagent-driven-development 而非本技能。
